...
{
    public class MockPartyRepo : IPartyRepo
    {
        public void AddAdventurer(string partyName, [FromBody] Model.Adventurer adventurer)
        {
        ...
        public Model.Party GetParty(string partyName)
        {
